...
public class FiltererScreen extends AbstractContainerScreen<FiltererMenu> {
    private static final ResourceLocation TEXTURE =
            new ResourceLocation(TwindlingTweaks.MOD_ID, "textures/gui/filterer_gui.png");

    public FiltererScreen(FiltererMenu pMenu, Inventory pPlayerInventory, Component pTitle) {
